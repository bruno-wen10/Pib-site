...
import { AuthLink, AuthSection, HeaderContainer, LogoLink, LogoutButton, MobileMenuIcon, NavLinksContainer, NavWrapper, StyledNavLink, UserInfo,  } from "./Header-style";
